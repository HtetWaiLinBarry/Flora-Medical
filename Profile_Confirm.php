...
if(isset($_POST['btnlogin']))
{
     ...
     if ($count==0) 
     {
        ...
        if ($Doctor_count>0) 
        {
            ...
            echo "<script>window.location='Doctor_Profile.php?did=$DoctorID'</script>";
     ...
     else
     {
            ...
            window.location='Doctor_Profile.php?did=$DoctorID'</script>";
...
<div class="wrapper bgded overlay gradient" style="background-image:url('images/demo/backgrounds/doctor.jpg');">
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      ...
      <p>To view your profile, we will need to reconfirm your account information</p>
    </article>
    <!-- ################################################################################################ -->
  </div>
</div>
        ...
        <table align="center" width="40%" height="50%">
            ...
            <tr>
                 <td></td>
                 <td>
                    <input type="submit" name="btnlogin" class="btn submit_btn" value="Profile">
