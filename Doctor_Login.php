...
if(isset($_POST['btnlogin']))
{
     ...
     if ($count==0) 
     {
        ...
        if ($Doctor_count>0) 
        {
            ...
            echo "<script>window.location='index.php?did=$did'</script>";
     ...
     else
     {
            ...
            window.location='index.php?did=$did'</script>";
    ...
    <!-- ################################################################################################ -->
        ...
        <table align="center" width="40%" height="50%">
            ...
            <tr>
              ...
              <td>
                <a href="Doctor_Register2.php">Don't Have an Account? Register Now!</a>
              </td>
            </tr>
        </table>
        </form>
